...
- **零基础主线**:`frontmatter` → `part0` → `part1` 仅读主线 → `part2`(01/02/03/07/08/09/10/11) → `part3`(01/02/04/09) → `part4`(01/05) → `part5`(01/02/04/06/07/08) → `part6` 全部 → `part7` 结语。读完即可动手做出可评估、可约束的 Agent。
...
> 汇总前六个 Part 的知识,从 0 搭一个“个人研究助手”,按步骤递进。
