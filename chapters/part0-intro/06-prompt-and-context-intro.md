...
Part 0 到这里完成了基础直觉:我们知道了 AI 和 LLM 的来路,知道了 Agent 是什么、为什么需要它,也知道了调用 LLM 时最基本的 API、参数和上下文概念。下一篇会开始打开 LLM 黑盒,先从 Tokenizer、词表和 Chat Template 讲起,再进入向量、矩阵、概率直觉与 Transformer 的内部世界。
